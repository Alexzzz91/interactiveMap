...
function SvgProjectavatar(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      id="projectavatar_svg__Default"
    ...
    >
      <style>
        {
          ".projectavatar_svg__st1{fill:#4a2593}.projectavatar_svg__st3{opacity:.15;fill:#7f4cbf;enable-background:new}.projectavatar_svg__st4{fill:#fff}"
        }
      </style>
      <path
      ...
      />
      <path
        className="projectavatar_svg__st1"
      ...
      <path
        className="projectavatar_svg__st3"
      ...
      />
      <path
        className="projectavatar_svg__st4"
      ...
      <path
        ...
        fill="#59afe1"
      />
      <circle className="projectavatar_svg__st4" cx={63.9} cy={50.7} r={11.1} />
...
export default SvgProjectavatar;
