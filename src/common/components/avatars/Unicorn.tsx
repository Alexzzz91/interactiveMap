...
function SvgUnicorn(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={48}
      height={48}
    ...
    >
      <rect
        ...
        height={48}
        rx={24}
        fill="url(#Unicorn_svg__paint0_radial)"
      />
      <path d="M12 35.68h24v-24H12v24z" fill="url(#Unicorn_svg__pattern0)" />
      <defs>
        <radialGradient
          id="Unicorn_svg__paint0_radial"
          cx={0}
          cy={0}
          r={1}
